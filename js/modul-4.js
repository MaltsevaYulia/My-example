...
//           if (pizza === pizzaName) {
//            return massage = makePizza(pizzaName);
//           } else {
//               massage= onOrderError(`There is no pizza with a name ${pizzaName} in the assortment.`);
//           }
//         }
//         return massage;
//   },
...
//     firstArray.forEach(function checkCommon(element) {
//         console.log(element);
...
// const uniqueGenres = allGenres.filter((genres,i,arrey)=>arrey.indexOf(genres)===i);
...
//   return allfriends.filter((friend, index,arrey)=>arrey.indexOf(friend)===index)
// };
// // Change code above this line
...
//   return users.reduce((totalBalanse,users)=>totalBalanse+users.balance,0)
...
//   (firstAutor,secondAutor) => firstAutor.author.localeCompare(secondAutor.author));

// const sortedByReversedAuthorName = [...books].sort(
//   (firstAutor,secondAutor) => secondAutor.author.localeCompare(firstAutor.author)
// );

// const sortedByAscendingRating = [...books].sort(
//   (firstRating,secondReting)=>firstRating.rating-secondReting.rating
// );

// const sortedByDescentingRating = [...books].sort(
//   (firstRating,secondReting)=>secondReting.rating-firstRating.rating
// );
//===============================================================
// 45/48
...
//   element=>element.rating>MIN_BOOK_RATING
// ).sort(
...
const getTotalBalanceByGender = (users, gender) => {
  return [...users].filter(users => users.gender === gender).reduce(
  (total,users)=>total+users.balance,0
)
};
